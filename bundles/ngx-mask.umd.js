        ...
        MaskDirective.prototype._setMask = function () {
            ...
            if (this._maskExpressionArray.length > 0) {
                this._maskExpressionArray.some(function (mask) {
                    var _a, _b;
                    var test = _this._inputValue &&
                        ((_a = _this._maskService.removeMask(_this._inputValue)) === null || _a === void 0 ? void 0 : _a.length) <= ((_b = _this._maskService.removeMask(mask)) === null || _b === void 0 ? void 0 : _b.length);
